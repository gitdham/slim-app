...
class ProductTest extends BaseTestCase {
  ...
  public function test_get_selected_product() {
    ...
    $this->assertEquals(9999.00, $data['price']);
    $this->assertEquals('test_img.png', $data['img']);
  }
  ...
  public function test_get_selected_product_not_found() {
    $response = $this->runApp('GET', '/product/9abc');
  ...
  public function test_put_product_success() {
    ...
    $response = $this->runApp('PUT', '/product', $post_data);
